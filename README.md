...
running command...
$ dugit (--version)
dugit/0.1.7 linux-x64 node-v18.20.4
$ dugit --help [COMMAND]
USAGE
  $ dugit COMMAND
...
...
_See code: [src/commands/auth/index.ts](https://github.com/braydenoneal/dugit/blob/v0.1.7/src/commands/auth/index.ts)_
...
_See code: [src/commands/auth/login.ts](https://github.com/braydenoneal/dugit/blob/v0.1.7/src/commands/auth/login.ts)_
...
_See code: [src/commands/auth/logout.ts](https://github.com/braydenoneal/dugit/blob/v0.1.7/src/commands/auth/logout.ts)_
...
_See code: [src/commands/classroom/index.ts](https://github.com/braydenoneal/dugit/blob/v0.1.7/src/commands/classroom/index.ts)_
...
_See code: [src/commands/org/index.ts](https://github.com/braydenoneal/dugit/blob/v0.1.7/src/commands/org/index.ts)_
